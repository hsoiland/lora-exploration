...
def process_image(img_path, output_dir, target_size=(512, 512), square_crop=True):
...
def main():
    # Configuration
    source_dir = '/home/harry/loras/gina photos'
    output_dir = '/home/harry/loras/gina_dataset'
    captions_file = os.path.join(output_dir, 'captions.json')
    target_size = (512, 512)  # Good size for LoRA training
    square_crop = True
