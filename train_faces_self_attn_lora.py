...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a LoRA using face images")
    ...
    parser.add_argument("--output_dir", type=str, default="rust_lora_trained", 
...
def main():
    try:
        ...
        lora_checkpoint_path = os.path.join(args.output_dir, f"{args.lora_name}_checkpoint.safetensors")
        lora_weights = train_lora_for_self_attention(
            unet=unet,
            output_path=lora_checkpoint_path,
            rank=args.rank,
                    ...
                    for module_name in self_attn_modules:
                        ...
                        if module is not None and hasattr(module, 'weight'):
                            ...
                            if lora_down_key in lora_params and lora_up_key in lora_params:
                                ...
                                # Apply LoRA (without Rust for now, just to calculate gradients correctly)
